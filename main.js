document.addEventListener("DOMContentLoaded", function () {
  const products = [
    {
      ...
      description:
        "The #1 New York Times bestseller.<hr>Over 20 million copies sold! Tiny Changes, Remarkable ResultsNo matter your goals, Atomic Habits offers a proven framework for improving every day.James Clear, one of the world's leading experts on habit formation, reveals practical strategies that will teach you exactly how to form good habits, break bad ones, and master the tiny behaviors that lead to remarkable results.",
      price: 50000,
    ...
    },
    {
      ...
      description:
        "Master one of our economy’s most rare skills and achieve groundbreaking results with this “exciting” book (Daniel H. Pink) from an “exceptional” author (New York Times Book Review)<hr> Deep Work is the ability to focus intensely on demanding tasks, enabling quick mastery of complex information and improved productivity. This skill enhances performance and brings fulfillment, acting as a competitive advantage in today's fast-paced economy.",
      price: 70000,
    ...
    },
    {
      ...
      description:
        "New in Paperback! Make learning more meaningful by teaching the 'whole game'<hr>'Making Learning Whole' by David Perkins advocates for teaching through the 'whole game' approach, where students learn more effectively by understanding the big picture. Perkins outlines seven principles to enhance learning, including motivating students, focusing on challenging areas, and promoting self-directed learning for deeper engagement and mastery.",
      price: 65000,
  ...
  function updateCartDisplay() {
    ...
    cartCountElement.innerText = isLoggedIn
      ...
      <div class="col www">
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-danger fw-bold">${formatPrice(
              product.price
            )}</p>
